...
switch lower(method)
    case 'coclustercorrelation5'
        load('SimilitudCoClusterCorrelationUser5.mat');
    case 'coclustercorrelation10'
        load('SimilitudCoClusterCorrelationUser10.mat');
    case 'coclustercorrelation20'
        load('SimilitudCoClusterCorrelationUser20.mat');
    case 'coclustercorrelation30'
        load('SimilitudCoClusterCorrelationUser30.mat');
    case 'coclustercorrelation40'
        load('SimilitudCoClusterCorrelationUser40.mat');
    case 'coclustercorrelation50'
        load('SimilitudCoClusterCorrelationUser50.mat');
end
%cluster
