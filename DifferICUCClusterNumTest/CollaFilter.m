...
switch lower(method)
    case 'coclustercorrelation5'
        load('SimilitudCoClusterCorrelationItem5.mat');
    case 'coclustercorrelation10'
        load('SimilitudCoClusterCorrelationItem10.mat');
    case 'coclustercorrelation20'
        load('SimilitudCoClusterCorrelationItem20.mat');
    case 'coclustercorrelation30'
        load('SimilitudCoClusterCorrelationItem30.mat');
    case 'coclustercorrelation40'
        load('SimilitudCoClusterCorrelationItem40.mat');
    case 'coclustercorrelation50'
        load('SimilitudCoClusterCorrelationItem50.mat');
end
%cluster
