function [ACCItemSim] = AHPCoClusterItemSim(ga,iccluster,uccluster,method)
...
[P,Q]=size(ga.train);
%对用户维聚类
user=kmeans(ga.train,uccluster, 'distance',method,'emptyaction','drop');
m=1;
for i=1:uccluster 
...
clear i j temp
%联合聚类
item=kmeans(ga.train',iccluster, 'distance',method,'emptyaction','drop');
n=1;
for i=1:iccluster
